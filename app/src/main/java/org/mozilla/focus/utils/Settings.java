...
public class Settings {
    ...
    public float getNightModeBrightnessValue() {
        return settingPreferenceWrapper.getFloat(getPreferenceKey(R.string.pref_value_night_mode_brightness), WindowManager.LayoutParams.BRIGHTNESS_OVERRIDE_NONE);
    }

    public void setNightModeBrightnessValue(float value) {
        preferences.edit().putFloat(getPreferenceKey(R.string.pref_value_night_mode_brightness), value).apply();
    }
