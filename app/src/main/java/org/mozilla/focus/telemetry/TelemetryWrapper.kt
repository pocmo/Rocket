...
object TelemetryWrapper {
    ...
    @TelemetryDoc(
            ...
            value = "",
            extras = [TelemetryExtra(name = Extra.SOURCE, value = "other")])
    ...
    @TelemetryDoc(
            ...
            `object` = Object.FIND_IN_PAGE,
            value = "",
            extras = [TelemetryExtra(name = Extra.SOURCE, value = "close_button")])
    ...
    @TelemetryDoc(
            ...
            `object` = Object.FIND_IN_PAGE,
            value = "",
            extras = [TelemetryExtra(name = Extra.SOURCE, value = "back_button")])
